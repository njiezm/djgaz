...
@section('title', 'La Bande Joyeuse | DJ GAZ')

@section('content')
<section id="bande-joyeuse" class="content-section active">
    <div class="container">
        <div class="bande-joyeuse-box">
            <div class="row">
                <div class="col-lg-8">
                    <h2 class="display-2 text-gold">LA BANDE JOYEUSE</h2>
                    <p class="serif fs-3 text-white mb-4">L'aventure humaine et musicale.</p>
                    <p class="lead">Le collectif emblématique qui a porté DJ GAZ vers des sommets. Plus qu'un groupe, une famille de scène qui a tourné partout, portant la joie et le rythme au plus profond des cœurs.</p>
